...
> Si vous souhaitez rédiger sur Wiki-Tech, c’est possible ! N’hésitez pas à m’envoyer un mail à [mickael@papamica.com](mailto:mickael@papamica.com) ❤️

# Les différentes catégories

## Docker

-   [🐳 Présentation *Qu’est-ce que c’est et pourquoi l’utiliser ?*](/Docker/Pr%C3%A9sentation)
...
-   [🖧 Les réseaux *Comprendre et utiliser les réseaux*](/Openstack/R%C3%A9seaux)
...
-   [✨ Les bases *Avant de commencer…*](/R%C3%A9seaux/Bases)
-   [💠 OpenVPN sur pfSense *Comment installer et utiliser un serveur OpenVPN sur pfSense*](/R%C3%A9seaux/pfSense-OpenVPN)
-   [🌲 Spanning-Tree *Qu’est-ce que c’est et à quoi ça sert ?*](/R%C3%A9seaux/Spanning-Tree)
-   [🪝 Protocole TCP/UDP *Liste des principaux protocoles et leur port*](/R%C3%A9seaux/TCP-UDP)
-   [🧪 Modèle OSI *Présentation et détails de chaques couches*](/R%C3%A9seaux/OSI)
-   [⛓️ Serveur DNS *Qu’est-ce que c’est et à quoi ça sert ?*](/R%C3%A9seaux/DNS)
-   [📌 Serveur DHCP *Qu’est-ce que c’est et à quoi ça sert ?*](/R%C3%A9seaux/DHCP)
-   [🎭 Calculer les masques *Comment calculer ces sal\*peries sans internet ?*](/R%C3%A9seaux/Masques)
-   [🦝 Switch (commutateur) *Comment fonctionnent-il ?*](/R%C3%A9seaux/Masques)

## Sécurité

-   [✨ Les bases *Avant de commencer…*](/S%C3%A9curit%C3%A9/Bases)
-   [🔴 Red Team *Fatty trouve un nom stp*](/S%C3%A9curit%C3%A9/Red-Team)

## VMware ESXi

-   [🌀 Installation *Installation de l’hyperviseur ESXi (6.0 / 6.5 / 6.7 / 7.0)*](/ESXi/Installation)
-   [✨ Création d’une VM *Créer sa première machine virtuelle*](/ESXi/Cr%C3%A9ation-VM)
